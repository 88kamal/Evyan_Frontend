...
const TABLE_HEAD = ["S.No", "Name", "Email", "Mobile Number", "Designation", "Edit", "Delete"];

export default function ViewAdministration() {
            ...
            <div className="overflow-scroll p-2">
                {isLoading ? (
                    ...
                    <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-4">
                        {users?.data?.map(({ _id, name, email, mobileNumber, role }) => (
                            <div key={_id} className="border border-purple-300 rounded-md">
                                <div className="p-2">
                                    ...
                                    <Typography className="text-sm text-gray-900">
                                        <b>Designation:</b> {
                                            role === 1 ? "Director" :
                                                role === 5 ? "Property Manager" :
                                                    role === 4 ? "Packer & Movers Manager" : ""
                                        }
                                    </Typography>
