...
//   "../../../new/11.jpg", "../../../new/12.jpg", "../../../new/13.jpg", "../../../new/14.jpg", "../../../new/15.jpg",
//   "../../../new/16.jpg", "../../../new/17.jpg",
// ];
...
//   return (
//     <div
//       className="relative w-screen h-auto max-w-none"
//       style={{
//         aspectRatio: isMobile ? "9/16" : "16/7",
//         maxHeight: "100svh",
//         background: "#000",
//         overflow: "hidden",
//       }}
...
//         >
//           {/* Image always from top, never cropped, never black bar above */}
//           <img
...
//               margin: "0 auto",
//               display: 'block',
//               background: 'transparent', // transparent bg for image
//             }}
//           />

//           {/* Soft dark gradient overlay (top-to-bottom), no solid black */}
//           <div className="
//             absolute inset-0
...
//           {/* Content OVERLAY (transparent bg only) */}
...
//                     `}
//                     style={isMobile ? { maxWidth: "90vw", position: 'relative', background: "transparent" } : {}}
//                   >
...
//       {/* Optional Blurs */}
//       <motion.div
//         className="absolute top-1/4 left-1/4 w-36 h-36 sm:w-64 sm:h-64 rounded-full bg-[#00a7da] opacity-10 blur-3xl pointer-events-none"
//         animate={{ scale: [1, 1.2, 1] }}
//         transition={{ duration: 7, repeat: Infinity }}
//       />
//       <motion.div
//         className="absolute bottom-1/3 right-1/4 w-32 h-32 sm:w-48 sm:h-48 rounded-full bg-[#00a7da] opacity-10 blur-3xl pointer-events-none"
...
const HeroSection = () => {
  ...
  return (
    <div
      // 🔥 Mobile: aspect-[9/16] Desktop: aspect-[16/7] + 100vh fallback
      className={
    ...
    >
      <AnimatePresence initial={false}>
        ...
        >
          <img
            src={bannerImages[currentIndex]}
            alt={currentModel?.name || ''}
            // 🔥 This is the magic: object-cover always, full container
            className="w-full h-full object-cover object-center select-none pointer-events-none"
            draggable={false}
          />

          {/* --- All your overlay/text UI below, unchanged --- */}
          ...
          {/* Dots, Arrows, Blurs -- your original code below this line */}
          {/* ...same as before... */}
          <div className="absolute left-0 right-0 bottom-20 sm:bottom-12 flex justify-center z-20">
            <div className="flex gap-1 sm:gap-2">
              {bannerImages.map((_, idx) => (
      ...
      {/* Animated decorative blurs, unchanged */}
      <motion.div
